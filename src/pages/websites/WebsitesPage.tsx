...
export function WebsitesPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 pb-16">
      <header className="flex flex-col items-stretch gap-5 border-b border-slate-200 pb-8 sm:flex-row sm:items-end sm:justify-between">
        <div>
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-800"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-700 to-blue-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm"
          >
          ...
          {sites.map((site) => (
            ...
            >
              ...
              <div className="mt-4 flex items-start justify-between gap-3">
                <h2 className="min-w-0 break-words font-semibold">{site.name}</h2>
                <span
        ...
        {step === 1 ? (
          <>
            ...
            <div className="mt-6 flex justify-stretch sm:justify-end">
              <button
                onClick={() => setStep(2)}
                className="w-full rounded-xl bg-blue-700 px-5 py-2.5 text-sm font-semibold text-white sm:w-auto"
              >
                Continue
              </button>
            </div>
