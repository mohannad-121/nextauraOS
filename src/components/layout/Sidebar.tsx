...
export const Sidebar: React.FC = () => {
  ...
  const rawHrModules = [
    ...
    { key: 'time_off', id: 'time-off', title: 'Time Off & Leave', icon: CalendarIcon, color: 'text-purple-600 dark:text-purple-400', subViews: [{ id: 'overview', label: 'Leave Overview' }, { id: 'requests', label: 'Pending Approvals' }, { id: 'calendar', label: 'Team Leave Calendar' }] },
